...
public class DegreeController extends HttpServlet {
    /**
     * POST, http://49.234.103.40:8080/workspace/degree.ctl, 增加学位
    ...
    /**
     * DELETE, http://49.234.103.40:8080/workspace/degree.ctl?id=1 删除id=1的学位
    ...
    /**
     * PUT,  http://49.234.103.40:8080/workspace/degree.ctl, 修改学位
     *
    ...
    /**
     * GET,  http://49.234.103.40:8080/workspace/degree.ctl?id=1, 查询id=1的学位
     * GET,  http://49.234.103.40:8080/workspace/degree.ctl, 查询所有的学位
     * 把一个或所有学位对象响应到前端
     * @param request
     * @param response
     * @throws ServletException
